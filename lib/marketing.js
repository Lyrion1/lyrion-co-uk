 ...
 */
export function getSignDetails(sign) {
 ...
 */
export function getWeeklySignDetails() {
 ...
 */
export function getNextWeekSign() {
  const now = new Date();
 ...
 */
export function getYearlyRotationSchedule() {
  const schedule = [];
  const now = new Date();
 ...
 */
export function isSignFeaturedThisWeek(sign) {
 ...
 */
export function getWeeklySignMarketingCopy(sign = null) {
